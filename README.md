...
Essa é a aplicação que registra, atualiza ou busca requisições no banco enviadas pelos usuários através da aplicação Client Web.
...
| [client](https://github.com/doceGraceseCommerce/client)           | Aplicação Client Web com a interface do usuário                                    |
| [server](https://github.com/doceGraceseCommerce/server)           | Aplicação Server que recebe as requisições do usuário e armazena ou busca no banco |
